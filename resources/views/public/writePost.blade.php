            ...
            <div class="col-md-8">
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        ...
                        <p>Στείλτε μια είδηση για δημοσίευση. Η δημοσίευση δεν γίνεται άμεσα, αλλά <strong>μετά από έλεγχο</strong>.
                        Θα γίνεται η επεξεργασία της μορφοποίησης, θα μπαίνει σχετική φωτογραφία και ότι άλλο χρειαστεί
