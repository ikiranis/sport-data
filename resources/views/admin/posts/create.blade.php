                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('posts.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="input-group mb-3 no-gutters">
                                ...
                                <input type="text" class="form-control col-9 px-2" id="title" name="title">
                            </div>
                            ...
                            <div class="input-group mb-3 no-gutters">
                                ...
                                <input type="text" class="form-control col-9 px-2" id="reference" name="reference">
                            </div>
                            ...
                            <div class="input-group mb-3 no-gutters">
                                ...
                                <select class="form-control col-9 px-2" id="team_id" name="team_id">
                            ...
                            <div class="input-group mb-3 no-gutters">
                                ...
                                <select class="form-control col-9 px-2" id="athlete_id" name="athlete_id">
